...
int adm_Uppercut(int argNum, gentity_t *adm, qboolean shortCmd)
{
    ...
    Boe_ClientSound(ent, G_SoundIndex("sound/weapons/rpg7/fire01.mp3", qtrue));
...
int adm_Burn(int argNum, gentity_t *adm, qboolean shortCmd)
{
    ...
    Boe_ClientSound(ent, G_SoundIndex("/sound/weapons/incendiary_grenade/incen01.mp3", qtrue));
